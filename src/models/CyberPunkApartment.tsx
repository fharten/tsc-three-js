...
import type { CyberpunkApartmentGLTF } from '../types/CyberpunkApartmentGLTF';

import islandScene from '/assets/3d/cyberpunkapartment.glb';
...
export function CyberpunkApartment({
  ...
  const { nodes, materials } = useGLTF(
    islandScene,
  ) as unknown as CyberpunkApartmentGLTF;
    ...
    if (!isRotating) {
      ...
      switch (true) {
        ...
        case normalizedRotation >= 1.4 && normalizedRotation <= 1.8:
          setCurrentStage(2);
          break;
        case normalizedRotation >= 2.5 && normalizedRotation <= 2.8:
          setCurrentStage(1);
          break;
        default:
    ...
    <a.group ref={islandRef} {...props}>
      <group rotation={[Math.PI / 2, 0, 0]}>
        <mesh
          ...
          material={materials.UV_TEST}
        />
        <mesh
          castShadow
          receiveShadow
          geometry={nodes.Object_5.geometry}
          material={materials['gran.001']}
        />
        <mesh
          castShadow
          receiveShadow
