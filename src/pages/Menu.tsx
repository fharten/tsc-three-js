  ...
  return (
    <section className='relative flex lg:flex-row flex-col max-container overflow-hidden'>
      <div className='flex-1 min-w-[50%] flex flex-col gap-y-5'>
        ...
        <h1 className='text-3xl font-black'>ESPRESSO CLASSICS</h1>
        ...
        <div className='bg-stone-50 text-stone-900 -mx-[50vw] px-[50vw] pb-5'>
        ...
        <div className='bg-stone-50 text-stone-900 -mx-[50vw] px-[50vw] pb-5'>
          <h1 className='text-3xl font-black mt-12'>SMALL BITES & PASTRIES</h1>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-10'>
